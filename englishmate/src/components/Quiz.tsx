    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-zinc-400 animate-pulse">
          Generating English questions... This may take a moment.
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="py-10">
        ...
        <button
          ...
          className="mt-4 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-md text-sm transition-colors"
        >
          Retry
        </button>
      </div>
          ...
          {!verdict ? (
            <div>
              <textarea
                ...
                rows={5}
                className="w-full bg-zinc-900 border border-zinc-700 rounded-lg p-4 text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 resize-y text-sm"
                onKeyDown={(e) => {
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-white rounded-md text-sm font-medium transition-colors"
                >
